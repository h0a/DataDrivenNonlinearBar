...
# solving
uhat, ebar, sbar, costFunc_global = directSolverLinearBar(node_vector=node_vector, data_set=SE, costFunc_ele=costFunc_ele, num_ele=num_ele, costFunc_constant=costFunc_constant, bar_distF=bar_distF, cross_section_area=bar_area);
