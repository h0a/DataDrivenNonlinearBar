...
@testset "NewtonRaphsonStep" begin
    ...
    rhs = assembleRhsLinearBar(data_star=data_star, node_vector=node_vector, num_ele=num_ele, ndofs=ndofs, costFunc_constant=costFunc_constant, bar_distF=bar_distF, cross_section_area=bar_area)
    ...
    x_nonlin = NewtonRaphsonStep(previous_sol=zeros(ndof_tot), data_star=data_star, node_vector=node_vector, num_ele=num_ele, ndofs=ndofs, costFunc_constant=costFunc_constant, bar_distF=bar_distF, cross_section_area=bar_area, constrained_dofs=constrained_dofs)
